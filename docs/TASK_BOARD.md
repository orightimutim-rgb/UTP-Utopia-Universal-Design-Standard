...
| T-010 | 在 GitHub Settings 開啟 Issues | 人類（網頁） | Settings → Features | Agent 無 admin |
| T-014 | 貼上更新後的 ChatGPT 自訂指令 | 人類 | `chatgpt-custom-instructions.md` | 含 Keep 規則 |
...
| ID | 標題 | 連結 |
|----|------|------|
| T-001 | GitHub ↔ ChatGPT 同步安排 | [#3](https://github.com/orightimutim-rgb/UTP-Utopia-Universal-Design-Standard/pull/3) |
| T-002 / T-011 | Cloud Agent 串流穩定度 | [#2](https://github.com/orightimutim-rgb/UTP-Utopia-Universal-Design-Standard/pull/2) |
