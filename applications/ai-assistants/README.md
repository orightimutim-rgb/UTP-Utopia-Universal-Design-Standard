# AI 助理設定（applications/ai-assistants）

本目錄存放可直接貼到各 AI 產品的指令與同步說明，服務「手機優先、通用設計」的協作方式。

| 檔案 | 用途 |
|------|------|
| [chatgpt-custom-instructions.md](chatgpt-custom-instructions.md) | ChatGPT / Codex 自訂指令與交接範本 |
...
- 指令要短，適合手機複製貼上。
- 不寫入任何 secret。
- 與根目錄 `AGENTS.md`、`AI_WORKFLOW.md` 保持一致；衝突時以根目錄為準。
